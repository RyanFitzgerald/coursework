...
function autocomplete(input, latInput, lngInput) {
    ...
    // Don't submit form on pressing enter on address
...
function ajaxHeart(e) {
    ...
    _axios2.default.post(this.action).then(function (res) {
        var isHearted = _this.heart.classList.toggle('heart__button--hearted'); // Toggle class on button, reference with this.heart (name on button)
...
function loadPlaces(map) {
    ...
    _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
        ...
        var markers = places.map(function (place) {
            ...
            // Makes placeLng from first array member, placeLat from second in coordinates object
...
function typeAhead(search) {
    ...
    searchInput.on('keyup', function (e) {
        ...
        if (e.keyCode === 40 && current) {
            ...
            // First time pressing down
            next = items[0];
        } else if (e.keyCode === 38 && current) {
            // Press up and has a current one
